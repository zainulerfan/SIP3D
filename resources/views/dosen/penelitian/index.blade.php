...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex align-items-center gap-2">
            <a href="{{ route('dosen.dashboard') }}" class="btn btn-secondary btn-sm">
                Kembali
            </a>
            <div>
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('dosen.penelitian.export') }}" class="btn btn-success btn-sm">
                Unduh Excel
            </a>
                        ...
                        @forelse($penelitians as $item)
                            <tr>
                                ...
                                <td class="col-actions">
                                    <a href="{{ route('dosen.penelitian.show', $item) }}"
                                       class="btn btn-sm btn-outline-secondary">
                                        Detail
                                    </a>
                                    <a href="{{ route('dosen.penelitian.edit', $item) }}"
                                       class="btn btn-sm btn-outline-primary">
                                        Ubah
                                    </a>
                                    <form action="{{ route('dosen.penelitian.destroy', $item) }}"
                                          method="POST"
                                          class="d-inline"
